...
(function (t, e) {
            ...
            s.placeholder && s.placeholder.constructor !== String || (i = s.placeholder, s.placeholder = {
                element: function () {
                    ...
                    return "tr" === s ? e.currentItem.children().each(function () {
                        t("<td>Â </td>", e.document[0]).attr("colspan", t(this).attr("colspan") || 1).appendTo(n)
    ...
    t.extend(i.prototype, {
        ...
        _generateMonthYearHeader: function (t, e, i, s, n, o, a, r) {
            ...
            if (_ || (b += y + (!o && m && v ? "" : "Â ")), !t.yearshtml) if (t.yearshtml = "", o || !v) b += "<span class='ui-datepicker-year'>" + i + "</span>"; else {
            ...
            return b += this._get(t, "yearSuffix"), _ && (b += (!o && m && v ? "" : "Â ") + y), b += "</div>"
        },
    ...
    t.widget("ui.dialog", {
        ...
        _title: function (t) {
            this.options.title || t.html("Â "), t.text(this.options.title)
        },
    ...
    t.widget("ui.spinner", {
        ...
        _buttonHtml: function () {
            return "<a class='ui-spinner-button ui-spinner-up ui-corner-tr'><span class='ui-icon " + this.options.icons.up + "'>â–²</span>" + "</a>" + "<a class='ui-spinner-button ui-spinner-down ui-corner-br'>" + "<span class='ui-icon " + this.options.icons.down + "'>â–¼</span>" + "</a>"
        },
        _start: function (t) {
